...
namespace ConsolFromApp
{
    public partial class headCountUserControl1 : UserControl
    {
        ...
        private void headCountUserControl_Load(object sender, EventArgs e)
        {
            //MessageBox.Show("Load fn");
        ...
        private void maintable()
        {
            ...
            //server = localhost; uid = root; pwd = Y1012Jqkhkp; database = learnings
        ...
        private void dropDownForGocComboBox_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            if (dropDownForGocComboBox.SelectedIndex != -1)
            {
                DataTable dt = new DataTable();

                string selectedItem1 = dropDownForGocComboBox.SelectedItem.ToString(); // contains description as well
