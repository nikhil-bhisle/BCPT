...
namespace ConsolFromApp
{
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            MainForm.instance.user.Text = user.Text;
            gocMasterUserControl.instance.loginID = user.Text;
            ...
            projectMaster1.Visible = false;
            resourceMaster1.Visible = false;
            gocMasterUserControl1.Visible = false;
            auditUserControl1.Visible = false;
        }
        ...
        private void gocMasterBtn_Click(object sender, EventArgs e)
        {
            gocMasterUserControl1.Visible = true;
            headCountUserControl11.Visible = false;
            avaiCapView1.Visible = false;
            homeView11.Visible = false;
            rP_View2.Visible = false;
        ...
        private void projectMasterBtn_Click(object sender, EventArgs e)
        {
            gocMasterUserControl1.Visible = false;
            projectMaster1.Visible = true;
            headCountUserControl11.Visible = false;
            avaiCapView1.Visible = false;
            homeView11.Visible = false;
            rP_View2.Visible = false;
        ...
        private void resourceMasterBtn_Click(object sender, EventArgs e)
        {
            resourceMaster1.Visible = true;
            gocMasterUserControl1.Visible = false;
            projectMaster1.Visible = true;
            headCountUserControl11.Visible = false;
            avaiCapView1.Visible = false;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            allocation_Master1.Visible = false;
            trsView1.Visible = false;
            auditUserControl1.Visible = true;
        }
    }
}